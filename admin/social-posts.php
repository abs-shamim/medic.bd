...
$medic_social_database_status = medic_social_database_status();
$database_ready = (bool) $medic_social_database_status['ready'];
...
<div class="medic-social-wrap">
    ...
    <div class="medic-social-card">
        ...
        <?php if (!$database_ready): ?>
            <?php
            $medic_social_missing_tables = implode(', ', (array) ($medic_social_database_status['missing_tables'] ?? []));
            $medic_social_database_name = trim((string) ($medic_social_database_status['database_name'] ?? ''));
            ?>
            <div class="medic-social-alert medic-social-alert-error">
                <strong>Social module database is not ready.</strong><br>
                <?= $medic_social_missing_tables !== '' ? 'Missing tables: ' . e($medic_social_missing_tables) . '.' : 'The social tables could not be verified.' ?>
                <?= $medic_social_database_name !== '' ? ' Connected database: ' . e($medic_social_database_name) . '.' : '' ?>
            </div>
        <?php endif; ?>
