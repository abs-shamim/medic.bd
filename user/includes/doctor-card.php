...
<article class="medic-doctor-list-item">
  ...
  <link rel="stylesheet" href="<?php echo BASE_URL; ?>/user/assets/css/doctor-card-list.css">
  ...
  <div class="medic-doctor-list-photo">
    <?php if ($doctor_image_url !== ''): ?>
      <img
        ...
        loading="lazy"
        data-fallback-target=".medic-doctor-list-photo-fallback"
      >
    <?php endif; ?>

    <span class="medic-doctor-list-photo-fallback<?= $doctor_image_url === '' ? ' is-visible' : '' ?>">
