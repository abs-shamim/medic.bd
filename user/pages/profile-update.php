...
<link rel="stylesheet" href="<?php echo BASE_URL; ?>/user/assets/css/profile-update.css">
    ...
    <div class="pu-layout">
      ...
      <main>
        <?php if ($section !== 'requests'): ?>
          <form class="pu-card" method="POST" enctype="multipart/form-data" id="profileUpdateMainForm" data-districts="<?= json_encode($districts, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>" data-thanas="<?= json_encode($thanas, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>">
              ...
              <?php if ($section === 'image'): ?>
                <div class="pu-form-grid">
                  <div class="<?= e(pu_field_class('image', $doctor, $pending_data)) ?>">
                    ...
                    <?php if ($current_image_url !== ''): ?><img class="pu-image-preview" src="<?= e($current_image_url) ?>" alt="Doctor image preview" loading="lazy"><?php endif; ?>
                  ...
                  <div class="<?= e(pu_field_class('og_image', $doctor, $pending_data)) ?>">
                    ...
                    <?php if ($current_og_image_url !== ''): ?><img class="pu-image-preview pu-image-preview-wide" src="<?= e($current_og_image_url) ?>" alt="OG image preview" loading="lazy"><?php endif; ?>
...
<script src="<?php echo BASE_URL; ?>/user/assets/js/profile-update.js" defer></script>
