...
.medic-education-list {
    border-top: 1px solid #edf1f5;
}

.medic-education-item {
    padding: 15px 0;
    border-bottom: 1px solid #edf1f5;
}

.medic-education-item:last-child {
    padding-bottom: 0;
    border-bottom: 0;
}

.medic-education-item h3 {
    margin: 0 0 6px;
    color: #273b52;
    font-size: 16px;
    line-height: 1.45;
